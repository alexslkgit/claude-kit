...
Every task also gets a **board** board (`board` skill), an HTML page in Russian that he keeps
...
- **Watch the context. Past ~200k, stop at the next natural boundary**, a finished sub-task and
  never mid-step, write the handoff, and tell him to press `/clear`. **The words "press /clear" may only be said when the meter says so.** ⭐ Standing instruction,
...
below 200k. You cannot clear it yourself,
