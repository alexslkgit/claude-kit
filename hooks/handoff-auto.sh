...
reason = (
  ...
  "1. Bring the task's files up to date first: STATUS.md rewritten, DECISIONS.md appended, and "
  "the board rewritten only if one was requested this session. A handoff that only writes a "
  ...
  "3. Then say exactly one line to him: handoff written, compaction is about to happen "
  "automatically. No board link unless he asked for a board this session. Nothing else, and "
  "never tell him to press /clear "
